...
program test
    ...
    use functions, only: f, fevals, gevals,g
...
100 format("Using ",i2," threads")
    ...
    a = 0.d0
    b = 2.d0
    int_true = dsin(3.d0) +dsin(4.d0) - dsin(1.d0) - dsin(6.d0)
...
102 format("Total number of fevals: ",i10)
    ...
    do i=0,nthreads-1
        print 222,  i, gevals(i)
        222 format("gevals by thread ",i2,": ",i13)
        enddo
    print 333, sum(gevals)
    333 format("Total number of gevals: ",i10)
